...
/// An incident with its timeline, oldest first.
#[derive(Debug, Clone, Serialize, Deserialize, Default, PartialEq)]
pub struct IncidentDetailOut {
    ...
    #[serde(default)]
    pub events: Vec<IncidentEventOut>,
...
impl IncidentDetailOut {
    pub fn builder() -> IncidentDetailOutBuilder {
        <IncidentDetailOutBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct IncidentDetailOutBuilder {
    ...
    events: Option<Vec<IncidentEventOut>>,
...
impl IncidentDetailOutBuilder {
    ...
    pub fn events(mut self, value: Vec<IncidentEventOut>) -> Self {
    ...
    /// Consumes the builder and constructs a [`IncidentDetailOut`].
    /// This method will fail if any of the following fields are not set:
    /// - [`environment`](IncidentDetailOutBuilder::environment)
    /// - [`events`](IncidentDetailOutBuilder::events)
    /// - [`failing_checks`](IncidentDetailOutBuilder::failing_checks)
    /// - [`id`](IncidentDetailOutBuilder::id)
    /// - [`node_key`](IncidentDetailOutBuilder::node_key)
    /// - [`on_call_refs`](IncidentDetailOutBuilder::on_call_refs)
    /// - [`opened_at`](IncidentDetailOutBuilder::opened_at)
    /// - [`opened_by_ref`](IncidentDetailOutBuilder::opened_by_ref)
    /// - [`project_asset_id`](IncidentDetailOutBuilder::project_asset_id)
    /// - [`runbook_run_ids`](IncidentDetailOutBuilder::runbook_run_ids)
    /// - [`severity`](IncidentDetailOutBuilder::severity)
    /// - [`state`](IncidentDetailOutBuilder::state)
    /// - [`title`](IncidentDetailOutBuilder::title)
    /// - [`updated_at`](IncidentDetailOutBuilder::updated_at)
    pub fn build(self) -> Result<IncidentDetailOut, BuildError> {
        Ok(IncidentDetailOut {
