...
impl DeleteCellsRequest {
    pub fn builder() -> DeleteCellsRequestBuilder {
        <DeleteCellsRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct DeleteCellsRequestBuilder {
...
impl DeleteCellsRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`DeleteCellsRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`asset_id`](DeleteCellsRequestBuilder::asset_id)
    /// - [`end_column_index`](DeleteCellsRequestBuilder::end_column_index)
    /// - [`end_row_index`](DeleteCellsRequestBuilder::end_row_index)
    /// - [`start_column_index`](DeleteCellsRequestBuilder::start_column_index)
    /// - [`start_row_index`](DeleteCellsRequestBuilder::start_row_index)
    pub fn build(self) -> Result<DeleteCellsRequest, BuildError> {
        Ok(DeleteCellsRequest {
