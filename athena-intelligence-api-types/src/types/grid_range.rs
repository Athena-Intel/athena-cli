...
/// Rectangular cell range with 1-based, INCLUSIVE boundaries.
/// 
/// Unlike the Google Sheets API's GridRange (0-based, half-open end
/// indices), every index here is 1-based and inclusive: A1:C3 is
