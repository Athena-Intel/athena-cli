...
pub enum GetSystemRequestEnvironment {
    Development,
    Production,
...
impl Serialize for GetSystemRequestEnvironment {
...
impl<'de> Deserialize<'de> for GetSystemRequestEnvironment {
...
impl fmt::Display for GetSystemRequestEnvironment {
