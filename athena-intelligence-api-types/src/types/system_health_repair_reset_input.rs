...
pub struct SystemHealthRepairResetInput {
...
impl SystemHealthRepairResetInput {
    pub fn builder() -> SystemHealthRepairResetInputBuilder {
        <SystemHealthRepairResetInputBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct SystemHealthRepairResetInputBuilder {
    environment: Option<String>,
    node_key: Option<String>,
    project_asset_id: Option<String>,
}

impl SystemHealthRepairResetInputBuilder {
    ...
    /// Consumes the builder and constructs a [`SystemHealthRepairResetInput`].
    /// This method will fail if any of the following fields are not set:
    /// - [`environment`](SystemHealthRepairResetInputBuilder::environment)
    /// - [`node_key`](SystemHealthRepairResetInputBuilder::node_key)
    /// - [`project_asset_id`](SystemHealthRepairResetInputBuilder::project_asset_id)
    pub fn build(self) -> Result<SystemHealthRepairResetInput, BuildError> {
        Ok(SystemHealthRepairResetInput {
