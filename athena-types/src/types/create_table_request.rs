...
impl CreateTableRequest {
    pub fn builder() -> CreateTableRequestBuilder {
        <CreateTableRequestBuilder as Default>::default()
    }
}
...
impl CreateTableRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateTableRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`asset_id`](CreateTableRequestBuilder::asset_id)
    /// - [`end_column_index`](CreateTableRequestBuilder::end_column_index)
    /// - [`end_row_index`](CreateTableRequestBuilder::end_row_index)
    /// - [`start_column_index`](CreateTableRequestBuilder::start_column_index)
    /// - [`start_row_index`](CreateTableRequestBuilder::start_row_index)
    /// - [`table_id`](CreateTableRequestBuilder::table_id)
    /// - [`table_name`](CreateTableRequestBuilder::table_name)
    pub fn build(self) -> Result<CreateTableRequest, BuildError> {
